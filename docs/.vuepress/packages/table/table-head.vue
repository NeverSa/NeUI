          ...
          <div :class="cellClasses(column)">
            ...
            <template v-else>
              ...
              <span :class="[prefixCls + '-sort']" v-if="column.sortable">
                  {{getColumn(rowIndex, index)._sortTypee}}
                <i
                v-if="defaultSort"
                  class="iconfont ne-yousanjiaoxing"
                  style="transform: rotate(90deg);"
                  :class="{on: getColumn(rowIndex, index)._sortType === 'asc',}"
                  @click="handleSort(getColumn(rowIndex, index)._index, 'asc');defaultSort=!defaultSort"
                ></i>
                <i
                  v-if="!defaultSort"
                  class="iconfont ne-yousanjiaoxing"
                  ...
                  @click="handleSort(getColumn(rowIndex, index)._index, 'desc');defaultSort=!defaultSort"
                ></i>
              </span>
              <!-- <Poptip
...
export default {
  ...
  computed: {
    ...
    isSelectAll() {
      ...
      this.isSelectAllModel = isSelectAll;
      return isSelectAll;
    },
    headRows() {
